...
let coloredCar = {...updatedCar, color: "Red"};
...
function updateCarModel(carObj,newModel){
    return {...carObj, model: newModel}
}

console.log(updateCarModel(updatedCar,"My new model"));
console.log(updateCarModel(coloredCar,"My new model"));
...
let newModelCar = updateCarModel(coloredCar,"Camry");
